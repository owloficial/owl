...
namespace Symfony\Bridge\Doctrine2\Form\ChoiceList;

use Symfony\Component\Form\Util\PropertyPath;
use Symfony\Component\Form\Exception\FormException;
use Symfony\Component\Form\Exception\UnexpectedTypeException;
use Symfony\Component\Form\Extension\Core\ChoiceList\ArrayChoiceList;
use Doctrine2\ORM\EntityManager;
use Doctrine2\ORM\QueryBuilder;
use Doctrine2\ORM\NoResultException;

class EntityChoiceList extends ArrayChoiceList
{
    /**
     * @var Doctrine2\ORM\EntityManager
     */
    private $em;

    /**
     * @var Doctrine2\ORM\Mapping\ClassMetadata
     */
    private $class;
     ...
     *
     * @var Doctrine2\ORM\QueryBuilder
     */
    ...
    public function __construct(EntityManager $em, $class, $property = null, $queryBuilder = null, $choices = null)
    {
        ...
        if (!(null === $queryBuilder || $queryBuilder instanceof QueryBuilder || $queryBuilder instanceof \Closure)) {
            throw new UnexpectedTypeException($queryBuilder, 'Doctrine2\ORM\QueryBuilder or \Closure');
        }
        ...
        if ($queryBuilder instanceof \Closure) {
            ...
            if (!$queryBuilder instanceof QueryBuilder) {
                throw new UnexpectedTypeException($queryBuilder, 'Doctrine2\ORM\QueryBuilder');
            }
        }
