...
namespace Symfony\Bridge\Doctrine2\Form\DataTransformer;

use Symfony\Bridge\Doctrine2\Form\ChoiceList\EntityChoiceList;
use Symfony\Component\Form\Exception\UnexpectedTypeException;
use Symfony\Component\Form\Exception\TransformationFailedException;
use Symfony\Component\Form\DataTransformerInterface;
use Doctrine2\Common\Collections\Collection;
use Doctrine2\Common\Collections\ArrayCollection;
...
class EntitiesToArrayTransformer implements DataTransformerInterface
{
    ...
    public function transform($collection)
    {
        ...
        if (!($collection instanceof Collection)) {
            throw new UnexpectedTypeException($collection, 'Doctrine2\Common\Collections\Collection');
        }
