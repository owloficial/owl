...
use Doctrine2\DBAL\Connection;
use Doctrine2\ORM\Configuration;
use Doctrine2\ORM\EntityManager;
use Doctrine2\ORM\EntityRepository;
use Doctrine2\ORM\ORMException;
...
class Registry implements RegistryInterface
{
    ...
    public function getEntityManagerForClass($class)
    {
        ...
        if ($proxyClass->implementsInterface('Doctrine2\ORM\Proxy\Proxy')) {
