...
use Doctrine2\Common\Annotations\AnnotationReader;
...
class TestCase extends \PHPUnit_Framework_TestCase
{
    ...
    {
        if (!class_exists('Doctrine2\\Common\\Version')) {
    ...
    public function createYamlBundleTestContainer()
    {
        ...
        $container->setDefinition('my.platform', new \Symfony\Component\DependencyInjection\Definition('Doctrine2\DBAL\Platforms\MySqlPlatform'));
