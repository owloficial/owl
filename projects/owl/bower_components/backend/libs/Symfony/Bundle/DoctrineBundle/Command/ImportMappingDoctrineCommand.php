...
use Doctrine2\ORM\Mapping\Driver\DatabaseDriver;
use Doctrine2\ORM\Tools\DisconnectedClassMetadataFactory;
use Doctrine2\ORM\Tools\Export\ClassMetadataExporter;
use Doctrine2\ORM\Tools\Console\MetadataFilter;
