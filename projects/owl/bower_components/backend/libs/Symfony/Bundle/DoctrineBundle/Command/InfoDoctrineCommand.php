...
use Doctrine2\ORM\Mapping\MappingException;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /* @var $entityManager Doctrine2\ORM\EntityManager */
        ...
        if (!$entityClassNames) {
            throw new \LogicException(
                ...
                'or with XML/YAML in your bundles Resources/config/Doctrine2/ directory.'
            );
        }
