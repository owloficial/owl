...
abstract class AbstractDoctrineExtensionTest extends TestCase
{
    ...
    public function testDependencyInjectionConfigurationDefaults()
    {
        ...
        $this->assertEquals('Doctrine2\ORM\Configuration', $container->getParameter('doctrine.orm.configuration.class'));
        $this->assertEquals('Doctrine2\ORM\EntityManager', $container->getParameter('doctrine.orm.entity_manager.class'));
        $this->assertEquals('Proxies', $container->getParameter('doctrine.orm.proxy_namespace'));
        $this->assertEquals('Doctrine2\Common\Cache\ArrayCache', $container->getParameter('doctrine.orm.cache.array.class'));
        $this->assertEquals('Doctrine2\Common\Cache\ApcCache', $container->getParameter('doctrine.orm.cache.apc.class'));
        $this->assertEquals('Doctrine2\Common\Cache\MemcacheCache', $container->getParameter('doctrine.orm.cache.memcache.class'));
        ...
        $this->assertEquals('Doctrine2\Common\Cache\XcacheCache', $container->getParameter('doctrine.orm.cache.xcache.class'));
        $this->assertEquals('Doctrine2\ORM\Mapping\Driver\DriverChain', $container->getParameter('doctrine.orm.metadata.driver_chain.class'));
        $this->assertEquals('Doctrine2\ORM\Mapping\Driver\AnnotationDriver', $container->getParameter('doctrine.orm.metadata.annotation.class'));
        $this->assertEquals('Symfony\Bridge\Doctrine2\Mapping\Driver\XmlDriver', $container->getParameter('doctrine.orm.metadata.xml.class'));
        $this->assertEquals('Symfony\Bridge\Doctrine2\Mapping\Driver\YamlDriver', $container->getParameter('doctrine.orm.metadata.yml.class'));
    ...
    public function testEntityManagerMemcacheMetadataCacheDriverConfiguration()
    {
        ...
        $definition = $container->getDefinition('doctrine.orm.default_metadata_cache');
        $this->assertDICDefinitionClass($definition, 'Doctrine2\Common\Cache\MemcacheCache');
