            ...
            ->children()
                ->arrayNode('orm')
                    ...
                    ->children()
                        ...
                        ->scalarNode('proxy_dir')->defaultValue('%kernel.cache_dir%/Doctrine2/orm/Proxies')->end()
        ...
        $node
            ...
            ->prototype('array')
                ...
                ->children()
                    ...
                    ->scalarNode('class_metadata_factory_name')->defaultValue('Doctrine2\ORM\Mapping\ClassMetadataFactory')->end()
